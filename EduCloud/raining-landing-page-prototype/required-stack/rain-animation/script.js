requestAnimFrame = (function() {
    ...
    function rendu(ctx) {
        ...
        // Set background with desired transparency (opacity 0)
        ctx.fillStyle = 'rgba(' + controls.red + ',' + controls.green + ',' + controls.blue + ',' + 0 + ')';
        ctx.fillRect(0, 0, width, height); // This can stay if you want to still set the background color
        ...
        // Draw objects (Umbrella, Cup, Circle)
